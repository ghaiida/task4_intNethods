...
apikey = 'Bus7rT6JeNkZZ36g66Y-JJYim5JfWzUxiZALoEcmwzpo'
url = 'https://api.us-south.text-to-speech.watson.cloud.ibm.com/instances/c07e28b3-f04d-440e-91bd-f7b7baae680d'
...
def on_message(self, msg):
    ...
    if "results" in data:
        ...
        pr=(data['results'][0]['alternatives'][0]['transcript'])
        print(pr)

        #write text into file ..
        with open('mytxtprint.txt','w')as output:
            output.writelines(pr)
        ...
        with open('mytxtprintaudio.mp3','wb') as audio:
            audio.write(tts.synthesize(pr,accept='audio/mp3', voice='en-US_AllisonV3Voice').get_result().content)
